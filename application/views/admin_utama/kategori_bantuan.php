        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Kategori Bantuan</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                  ...
                                  $id = 0;
                                  foreach($kategori_bantuan as $i)
                                  :
                                  $id++;
                                  $id_kategori_bantuan = $i['id_kategori_bantuan'];
                                                    ...
                                                    <div class="table-responsive">
                                                        <div class="table table-striped table-hover ">
                                                            <a href="" class="btn btn-primary" data-toggle="modal"
                                                                data-target="#edit_kategori_bantuan<?= $id_kategori_bantuan ?>">
